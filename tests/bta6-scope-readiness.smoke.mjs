...
assert.equal(exactBta6(["NETWORK_FIXED", "NETWORK_POWER", "NETWORK_ENERGY", "METERING_FIXED", "TRANSMISSION_ENERGY"], "EUR/POD/YEAR").length, 0);
assert.doesNotMatch(JSON.stringify(records), /1968\.26|BTA6/i);
console.log("BTA6_MIS_2026_SOURCE_VERIFIED=NO");
console.log("BTA6_MIS_NORMALIZED_VALUE=");
console.log("BTA6_MIS_NORMALIZED_UNIT=");
console.log("BTA6_TRAS_E_SOURCE_VERIFIED=NO");
console.log("BTA6_TRAS_P_APPLICABLE=NO");
console.log("BTA6_TRAS_NORMALIZED_VALUE=");
console.log("BTA6_TRAS_NORMALIZED_UNIT=");
console.log("BTA6_POWER_BASIS_CONTRACT=UNRESOLVED");
console.log("AVAILABLE_POWER_FIELD_READY=YES");
console.log("CONTRACTED_POWER_FIELD_READY=YES");
console.log("MAX_EFFECTIVE_POWER_FIELD_READY=NO");
console.log("BTA6_ECONOMIC_IMPLEMENTATION=BLOCKED");
console.log("BTA6_ECONOMIC_BLOCKERS=NO_EXACT_BTA6_SOURCES;POWER_BASIS_UNRESOLVED;MAX_EFFECTIVE_POWER_FIELD_MISSING");
