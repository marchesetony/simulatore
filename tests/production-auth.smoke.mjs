...
ok(!loginRouteSource.includes("access_token") && !loginRouteSource.includes("refresh_token"), "SERVICE_ROLE_NEVER_CLIENT_VISIBLE");
...
ok(!/console\.(log|error).*password/i.test(bootstrapSource) && !bootstrapSource.includes("SUPABASE_SERVICE_ROLE_KEY=`"), "SERVICE_ROLE_AND_PASSWORD_NOT_PRINTED");
